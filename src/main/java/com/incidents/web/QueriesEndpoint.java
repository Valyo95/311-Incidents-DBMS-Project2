...
public class QueriesEndpoint {
	...
	public List<Object> second(@RequestParam("type") String type, @RequestParam("start") String start,
	...
	public List<Object> fifth(@RequestParam("start") String start, @RequestParam("end") String end)
			throws ParseException {
	...
	@RequestMapping(value = "/6", method = RequestMethod.GET, headers = "Accept=application/json", produces = "application/json")
	public List<Object> six(@RequestParam("day") String day, @RequestParam("x1") Double x1, @RequestParam("y1") Double y1, @RequestParam("x2") Double x2, @RequestParam("y2") Double y2) throws ParseException {
		return service.six(day, x1, y1, x2, y2);
	}
